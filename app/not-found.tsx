...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6 text-center">
      {/* Background Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#FF6B35]/10 blur-[150px] rounded-full pointer-events-none" />
      ...
      <div className="relative z-10">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-[#FF6B35] mb-4">
            Page Not Found
          </span>
          ...
          <Link
            href="/"
            className="group flex items-center gap-3 bg-foreground text-background px-8 py-4 rounded-full font-bold text-xs uppercase tracking-[0.3em] hover:bg-[#FF6B35] hover:text-white transition-all duration-500"
          >
